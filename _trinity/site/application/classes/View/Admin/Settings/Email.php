 ...
 */
class View_Admin_Settings_Email extends View_Protected_Admin_Layout
{
	...
	{
		$this->settings = Security::decode($this->m_settings->get_settings('email_template'));
	...
	{
		$this->post_url = Route::url('admin', array('controller' => 'settings', 'action' => 'email'));
	}
