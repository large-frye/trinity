...
* {
    ...
    <body>
        <!-- </div> -->
        <div id="page-wrap">
            <img src="<?php echo $_SERVER['DOCUMENT_ROOT'] . '/assets/gfx/logo-icon.png'; ?>" width="100" height="100" alt="test" style="text-align:center; margin-top: -40px;">
            <?php if (isset($data['damages']['wind_header']) || (isset($data['damages']['hail_header']) && !isset($data['damages']['wind_header']['no_report']))) { ?>
            <h3>Wind Damage</h3>
            ...
            <?php } if (isset($data['damages']['hail_header']) || (isset($data['damages']['hail_header']) && !isset($data['damages']['hail_header']['no_report']))) { ?>
