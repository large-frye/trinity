$(document).ready(function() {
    ...
    $('#was_roofer_present1').click(function() {
        $('was_roofer_present_entire1').parent().parent().parent().hide();
    ...
    $(".hide-btn").click(function() {
        if ($("#left").css("width") == "0px") {
            ...
            $(".hide-btn.top, .hide-btn.center, .hide-btn.bottom").animate({
                left: "223px"
            }, 500, function() {
    ...
    // INPUT FILTER
    $('.onlytext').filter_input({
        regex: '[a-zA-Z]'
    });
    $('.onlylow').filter_input({
        regex: '[a-z]'
    });
    $('.onlyup').filter_input({
        regex: '[A-Z]'
    });
    $('.onlynum').filter_input({
        regex: '[0-9]'
    });
    $('.onlyurl').filter_input({
        regex: '[a-zA-Z0-9_]'
    });
    ...
    var subs = {
        ...
        "ne_sw_se_nw": {
            str: "Northeast",
            values: ["Northeast", "Southwest", "Southeast", "Northwest"]
        }
    };
    var slope_statements = {
        "front": "During our inspection of the {{house_face}} (Front) facing slopes we found {{damaged}} {{type}}-damaged shingles.",
    ...
    var brittle_stmt = {
        str: "Brittleness test: The roof {{stmt}} found to be brittle."
    };
    ...
    $('#save-report').click(function() {
        ...
        if ($('.xact-report').val() == "0" && $('.report-type').val() != 'Basic') {
